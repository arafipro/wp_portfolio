          ...
          <ul id="footer_menu" class="footer_menu">
            <li>
              <a href="https://twitter.com/arafipro" target="_blank">
                <img src="<?php bloginfo("template_url");?>/images/logo-twitter.svg" alt="" />
              </a>
            </li>
            <li>
              <a href="https://zenn.dev/arafipro" target="_blank">
                <img src="<?php bloginfo("template_url");?>/images/logo-zenn.svg" alt="" />
              </a>
            </li>
          </ul>
        </nav>
        <a href="<?php bloginfo("template_url");?>/site_privacy.html" target="_blank">
          プライバシーポリシー
        </a>
